...
int main()
{
	...
	cout << endl << "Vamos a probar el constructor de copia, copiando v2" << endl;

	VectorDinamico *v4(v2); // Constructor de Copia

	cout << "Vamos a ver el contenido de v4" << endl;
	...
	cout << endl << "Vamos a imprimir el vector v5" << endl;
